 ...
 *       &lt;sequence>
 *         &lt;element ref="{cisco_cme_xml_namespace}services_id"/>
...
@XmlRootElement(name = "url_services_item")
public class UrlServicesItem {

    @XmlElement(name = "services_id", required = true)
