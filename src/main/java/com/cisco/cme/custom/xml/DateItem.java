 ...
 *         &lt;element ref="{cisco_cme_xml_namespace}month"/>
 *         &lt;element ref="{cisco_cme_xml_namespace}day_of_month"/>
...
@XmlRootElement(name = "date_item")
public class DateItem {

    protected String index;
    @XmlElement(required = true)
    protected String month;
    @XmlElement(name = "day_of_month", required = true)
