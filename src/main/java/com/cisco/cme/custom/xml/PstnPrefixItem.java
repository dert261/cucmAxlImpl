 ...
 *         &lt;element ref="{cisco_cme_xml_namespace}pstn-prefix"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "pstn-prefix_item")
public class PstnPrefixItem {

    @XmlElement(required = true)
    protected String index;
    @XmlElement(name = "pstn-prefix", required = true)
